...
func CreateSignedDatagram(session main.Session, dg *main.Datagram) error {
    ...
    return nil // No need to return the pointer, as the original datagram is modified
}
